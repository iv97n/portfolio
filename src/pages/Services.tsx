...
import { servicesItems, servicesPageMeta } from '../data/services';
                ...
                <div className="container">
                    ...
                    <div className="grid grid-cols-1 gap-10 lg:gap-[72px]">
                        {servicesItems.map((service, index) => (
                            <div key={index} className="lg:grid lg:grid-cols-[1fr,378px,minmax(auto,1fr)] lg:items-start lg:gap-10">
